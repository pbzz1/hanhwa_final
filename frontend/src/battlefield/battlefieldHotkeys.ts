...
/** 사이드바 등에서 대대 본부를 브라우저 현재 위치로 맞출 때 `window.dispatchEvent`로 요청 */
export const BATTLEFIELD_BATTALION_HQ_GEO_REQUEST_EVENT = 'battlefield:battalion-hq-geo-request'
