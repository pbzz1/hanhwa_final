...
export const BATTLEFIELD_MBT_MARCH_GOALS: Record<number, MarchPoint> = {
  // 군사분계선(MDL) 근사(위도 약 38°) 부근까지 남하하도록 종점을 조정 — 각 id는 OSRM driving 종점
  ...
  9004: { lat: 38.01, lng: 126.58 },
  9005: { lat: 37.94, lng: 126.88 },
  9006: { lat: 38.07, lng: 127.02 },
  9007: { lat: 37.91, lng: 127.38 },
  9008: { lat: 38.11, lng: 126.72 },
  9009: { lat: 37.97, lng: 127.52 },
  9010: { lat: 38.03, lng: 126.28 },
